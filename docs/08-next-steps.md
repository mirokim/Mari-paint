...
- ~~실제 펜으로 그려본 적 없음~~ ✅ 2026-09-19 Intuos Pro M 으로 필압 확인. ⚠ 첫 시도는 **마우스/터치**로 잡혔다 —
  와콤 드라이버의 "Windows Ink 사용"이 꺼져 있었다(펜을 마우스로 흉내내 보낸다). 켜니 바로 됐다.
  "필압 안 먹어요" 신고는 **보기 → 태블릿 테스터의 `입력:` 줄부터** 본다 — 마우스/터치면 드라이버 설정이다.
...
### 3.2 🔴 펜 입력 — Windows Ink만 ✅ 2026-09-18 (2026-09-19 와콤 실기 검증)
```cpp
